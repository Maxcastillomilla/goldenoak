...
function blacksilver_function_scripts_styles() {
	...
	wp_register_style( 'blacksilver-content-style', get_template_directory_uri() . '/css/styles-content.css', array( 'blacksilver-MainStyle' ), '1.2', 'screen' );
	...
	wp_enqueue_script( 'blacksilver-common', get_template_directory_uri() . '/js/common.js', array( 'jquery' ), '3.7', true );
