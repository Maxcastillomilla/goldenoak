...
function themecore_fullscreen_metadata() {
	...
	$mtheme_fullscreen_box = array(
		...
		'fields' => array(
			...
			array(
				'name' => esc_html__('Carousel Title','themecore'),
				'id' => 'pagemeta_carousel_title',
				'class' => 'page_type-carousel page_type-trigger',
				'type' => 'select',
				'std' => 'enable',
				'desc' => esc_html__('Display title','themecore'),
				'options' => array(
			...
			array(
				'name' => esc_html__('Carousel Description','themecore'),
				'id' => 'pagemeta_carousel_desc',
				'class' => 'page_type-carousel page_type-trigger',
				'type' => 'select',
				'std' => 'enable',
				'desc' => esc_html__('Display description','themecore'),
				'options' => array(
					'enable' => esc_html__('Enable','themecore'),
					'disable' => esc_html__('Disable','themecore')
					)
			...
			array(
				'name' => esc_html__('Carousel caption background color','themecore'),
				'id' => 'pagemeta_carouselbg_color',
				'type' => 'color',
				'class' => 'page_type-carousel page_type-trigger',
				'desc' => esc_html__('Background color','themecore'),
				'std' => ''
				),
			array(
				'name' => esc_html__('Carousel caption background opacity percent','themecore'),
				'id' => 'pagemeta_carouselbg_color_opacity',
				'heading' => 'subhead',
				'type' => 'text',
				'std' => '',
				'class' => 'page_type-carousel page_type-trigger',
				'desc' => esc_html__('1 to 100 . Type "transparent" for none','themecore'),
				),
			array(
			...
			array(
				'name' => esc_html__('Button Font','themecore'),
				'id' => 'pagemeta_sep_page_options',
				'type' => 'seperator',
				'class' => 'is-part-of-a-set page_type-carousel page_type-trigger',
				),
			array(
				'name' => esc_html__('Button font','themecore'),
			...
			array(
				'name' => esc_html__('Button color','themecore'),
				'id' => 'pagemeta_fullscreenbuttoncolor_meta',
				'type' => 'color',
				'class' => 'is-part-of-a-set page_type-carousel page_type-trigger',
				'desc' => esc_html__('Button color','themecore'),
				'std' => ''
				),
			array(
				'name' => esc_html__('Button Hover Text Color','themecore'),
