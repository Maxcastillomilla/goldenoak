...
class Events_Info extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'cost_icon',
			[
				'label' => __( 'Cose Icon', 'imaginem-blocks' ),
				'type' => Controls_Manager::ICON,
				'options' => mtheme_elementor_icons(),
		...
		$this->add_control(
			...
			[
				'type' => 'select',
				'group_title' => 'Properties',
				'label' => __('Display Capacity', 'imaginem-blocks'),
				'desc' => __('Display Capacity', 'imaginem-blocks'),
				'options' => [
					'true' => __('Yes','imaginem-blocks'),
					'false' => __('No','imaginem-blocks')
				],
		...
		$this->add_control(
			...
			[
		        'type' => Controls_Manager::TEXT,
		        'label' => __('Capacity Text', 'imaginem-blocks'),
				'default' => __( 'Capacity', 'imaginem-blocks' ),
				'placeholder' => __( 'Capacity', 'imaginem-blocks' ),
				'label_block' => true,
		    ]
		);
		...
		$this->add_control(
			'capacity_icon',
			[
				'label' => __( 'Capacity Icon', 'imaginem-blocks' ),
				'type' => Controls_Manager::ICON,
				'options' => mtheme_elementor_icons(),
		...
		$this->add_control(
			...
			[
				'type' => 'select',
				'group_title' => 'Properties',
				'label' => __('Display Remaining capacity', 'imaginem-blocks'),
				'desc' => __('Display Remaining capacity', 'imaginem-blocks'),
				'options' => [
					'true' => __('Yes','imaginem-blocks'),
					'false' => __('No','imaginem-blocks')
				],
		...
		$this->add_control(
			...
			[
		        'type' => Controls_Manager::TEXT,
		        'label' => __('Remaining capacity Text', 'imaginem-blocks'),
				'default' => __( 'Remaining capacity', 'imaginem-blocks' ),
				'placeholder' => __( 'Remaining capacity', 'imaginem-blocks' ),
				'label_block' => true,
		    ]
		);
