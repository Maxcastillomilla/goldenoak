	...
	protected function _register_controls() {
		...
		$this->add_control(
			'open_newlink',
				[
					'type' => \Elementor\Controls_Manager::SELECT,
					'label' => __('Open Links in New Tab', 'imaginem-blocks'),
					'desc' => __('Open Links in New Tab', 'imaginem-blocks'),
					'options' => [
						'default' => __('Default', 'imaginem-blocks'),
						'newtab' => __('New Tab', 'imaginem-blocks'),
					],
					'default' => 'default',
				]
		);
